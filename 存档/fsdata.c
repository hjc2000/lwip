...
static unsigned int const dummy_align__img_sics_gif = 0;
#endif
static unsigned char const FSDATA_ALIGN_PRE data__img_sics_gif[] FSDATA_ALIGN_POST = {
...
#if FSDATA_FILE_ALIGNMENT == 1
static unsigned int const dummy_align__404_html = 1;
#endif
static unsigned char const FSDATA_ALIGN_PRE data__404_html[] FSDATA_ALIGN_POST = {
    /* /404.html (10 chars) */
...
#if FSDATA_FILE_ALIGNMENT == 1
static unsigned int const dummy_align__index_html = 2;
#endif
static unsigned char const FSDATA_ALIGN_PRE data__index_html[] FSDATA_ALIGN_POST = {
    /* /index.html (12 chars) */
